					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown dropdown-user-profile">
							...
							<div class="dropdown-menu dropdown-menu-end">
                                ...
                                @else
                                    <a class="dropdown-item" href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-power-off"></i><span>Logout</span></a>
